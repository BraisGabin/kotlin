...
open class IrFileSerializer(
    ...
    private fun serializeAnnotations(annotations: List<IrConstructorCall>, parent: IrElement?) =
        annotations.map {
    ...
    private fun serializeAnnotation(annotation: IrConstructorCall, parent: IrElement?): ProtoAnnotation =
    ...
    private fun serializeStatement(statement: IrElement, parent: IrElement?): ProtoStatement {
        ...
        when (statement) {
            ...
            is IrExpressionBody -> {
                proto.expression = serializeExpression(statement.expression, statement)
            }
            else -> {
