...
fun test(
    ...
    val _ = nid(sa) ?: [1, 2, 3]
    val _: Set<Int> <!INITIALIZER_TYPE_MISMATCH!>=<!> nid(sa) ?: <!CANNOT_INFER_PARAMETER_TYPE!>nid<!>(<!CANNOT_INFER_PARAMETER_TYPE!>[]<!>)
    val _: Collection<Int> <!INITIALIZER_TYPE_MISMATCH!>=<!> nid(sa) ?: <!CANNOT_INFER_PARAMETER_TYPE!>nid<!>(<!CANNOT_INFER_PARAMETER_TYPE!>[]<!>)
