...
external interface Run {
  ...
  Run the program.
  */
  fun run(): Int // cheating a bit, normally this returns a Result<Unit>, but as we don't have abi translation for that yet, I manually changed the signature to the correctly lowered one: i32
}
