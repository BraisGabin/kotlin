...
dependencies {
    ...
    compileOnly(project(":dependencies:kotlin-build-tools-apis:kotlin-build-tools-api-last"))
    ...
    suites {
        ...
        withType<JvmTestSuite>().configureEach configureSuit@{
            ...
            dependencies {
                ...
                implementation(project(":dependencies:kotlin-build-tools-apis:kotlin-build-tools-api-last"))
                if (isRegular) {
                    addSnapshotBuildToolsImpl()
                }
            }
