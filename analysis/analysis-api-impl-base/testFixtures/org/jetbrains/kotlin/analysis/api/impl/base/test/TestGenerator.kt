...
import org.jetbrains.kotlin.analysis.api.impl.base.test.cases.components.symbolInfoProvider.AbstractSamMethodTest
...
private fun AnalysisApiTestGroup.generateAnalysisApiComponentsTests() {
    ...
    component("symbolInfoProvider") {
        ...
        test<AbstractSamMethodTest>(filter = frontendIs(FrontendKind.Fir)) {
            model(it, "samMethod")
        }
