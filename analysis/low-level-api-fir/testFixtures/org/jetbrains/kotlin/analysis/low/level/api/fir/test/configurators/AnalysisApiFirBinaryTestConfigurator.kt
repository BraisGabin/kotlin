...
class AnalysisApiFirLibraryBinaryTestConfigurator(override val defaultTargetPlatform: TargetPlatform) :
...
class AnalysisApiFirLibraryBinaryDecompiledTestConfigurator(override val defaultTargetPlatform: TargetPlatform) :
    AnalysisApiFirBinaryTestConfigurator() {
